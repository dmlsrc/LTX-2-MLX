#!/usr/bin/env python3
"""Tests for LTX_2_MLX.progress.PhaseBar / StackedPhaseBars.

A battery of assertions on PhaseBar's timing logic (deferred start,
...
The visual progress-bar demo CLI that used to live alongside these
assertions now lives in scripts/progress_demo.py.
"""
