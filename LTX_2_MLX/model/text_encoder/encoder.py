...
def load_text_encoder_weights(
    ...
    """
    Load text encoder weights from a safetensors file.
    ...
    if fe_key in weights:
        ...
        encoder.feature_extractor.aggregate_embed.weight = weights[fe_key]
        loaded_count += 1
    ...
    if reg_key in weights:
        encoder.embeddings_connector.learnable_registers = weights[reg_key]
        loaded_count += 1
...
def load_av_text_encoder_weights(
    ...
    """
    Load audio+video text encoder weights from a safetensors file.
